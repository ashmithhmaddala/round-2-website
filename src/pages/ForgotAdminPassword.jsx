...
const ForgotAdminPassword = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('/api/auth/forgot-admin-password', {
        method: 'POST',
  ...
  return (
    <div className="forgot-password-container">
      <div className="forgot-password-box">
        ...
        <p className="forgot-password-desc">Enter your admin email address and we'll send you a link to reset your admin password.</p>
